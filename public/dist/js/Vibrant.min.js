!(function t(r, o, i) {
  ...
  for (
    var e = "function" == typeof require && require, a = 0;
    a < i.length;
    a++
  )
    n(i[a]);
        ...
        var n = (function() {
                ...
                if (v[s] > A / 2) {
                  for (
                    n = o.copy(),
                      ...
                      a =
                        i >= r
                          ? Math.min(o[u] - 1, ~~(s + i / 2))
                          : Math.max(o[h], ~~(s - 1 - r / 2));
                    !v[a];
          ...
          return (
            ...
            (n.prototype = {
              ...
              nearest: function(t) {
                for (var r, o, i, n = this.vboxes, e = 0; e < n.size(); e++)
                  (o = Math.sqrt(
                    Math.pow(t[0] - n.peek(e).color[0], 2) +
                      Math.pow(t[1] - n.peek(e).color[1], 2) +
                      Math.pow(t[2] - n.peek(e).color[2], 2)
                  )),
                    (r > o || void 0 === r) && ((r = o), (i = n.peek(e).color));
                return i;
              },
              forcebw: function() {
                var t = this.vboxes;
      ...
      function(t, r, o) {
        (function() {
          ...
          (window.Swatch = o = (function() {
            ...
            return (
              (t.prototype.hsl = void 0),
              (t.prototype.rgb = void 0),
              (t.prototype.population = 1),
              (t.yiq = 0),
              ...
              (t.prototype.getTitleTextColor = function() {
                return (
                  this._ensureTextColors(), this.yiq < 200 ? "#fff" : "#000"
                );
              }),
              (t.prototype.getBodyTextColor = function() {
                return (
                  this._ensureTextColors(), this.yiq < 150 ? "#fff" : "#000"
                );
              }),
            ...
            (window.Vibrant = i = (function() {
                ...
                try {
                  for (
                    ...
                    (A = 4 * p),
                      ...
                      (a = T[A + 3]),
                      a >= 125 &&
                        ((g > 250 && c > 250 && u > 250) || h.push([g, c, u])),
                      (p += e);
                  (s = this.quantize(h, i)),
                    (this._swatches = s.vboxes.map(
                      (function(t) {
                        return function(t) {
              ...
              return (
                (i.prototype.quantize = t("quantize")),
                (i.prototype._swatches = []),
                (i.prototype.TARGET_DARK_LUMA = 0.26),
                (i.prototype.MAX_DARK_LUMA = 0.45),
                (i.prototype.MIN_LIGHT_LUMA = 0.55),
                (i.prototype.TARGET_LIGHT_LUMA = 0.74),
                (i.prototype.MIN_NORMAL_LUMA = 0.3),
                (i.prototype.TARGET_NORMAL_LUMA = 0.5),
                (i.prototype.MAX_NORMAL_LUMA = 0.7),
                (i.prototype.TARGET_MUTED_SATURATION = 0.3),
                (i.prototype.MAX_MUTED_SATURATION = 0.4),
                (i.prototype.TARGET_VIBRANT_SATURATION = 1),
                (i.prototype.MIN_VIBRANT_SATURATION = 0.35),
                (i.prototype.WEIGHT_SATURATION = 3),
                (i.prototype.WEIGHT_LUMA = 6),
                (i.prototype.WEIGHT_POPULATION = 1),
                (i.prototype.VibrantSwatch = void 0),
                (i.prototype.MutedSwatch = void 0),
                (i.prototype.DarkVibrantSwatch = void 0),
                (i.prototype.DarkMutedSwatch = void 0),
                (i.prototype.LightVibrantSwatch = void 0),
                (i.prototype.LightMutedSwatch = void 0),
                (i.prototype.HighestPopulation = 0),
                (i.prototype.generateVarationColors = function() {
                  return (
                ...
                (i.prototype.generateEmptySwatches = function() {
                  ...
                  return (
                    void 0 === this.VibrantSwatch &&
                      ...
                      ((t = this.DarkVibrantSwatch.getHsl()),
                      (t[2] = this.TARGET_NORMAL_LUMA),
                      (this.VibrantSwatch = new o(
                        i.hslToRgb(t[0], t[1], t[2]),
                        0
                      ))),
                    void 0 === this.DarkVibrantSwatch &&
                    void 0 !== this.VibrantSwatch
                      ? ((t = this.VibrantSwatch.getHsl()),
                        (t[2] = this.TARGET_DARK_LUMA),
                        (this.DarkVibrantSwatch = new o(
                          i.hslToRgb(t[0], t[1], t[2]),
                          0
                        )))
                      : void 0
                ...
                (i.prototype.findMaxPopulation = function() {
                  var t, r, o, i, n;
                  for (
                    o = 0, i = this._swatches, t = 0, r = i.length;
                    r > t;
                    t++
                  )
                    (n = i[t]), (o = Math.max(o, n.getPopulation()));
                  return o;
                }),
                (i.prototype.findColorVariation = function(t, r, o, i, n, e) {
                  var a, h, u, s, c, p, f, l, A;
                  for (
                    s = void 0, c = 0, p = this._swatches, a = 0, h = p.length;
                    h > a;
                    a++
                  )
                    (l = p[a]),
                      ...
                      f >= n &&
                        ...
                        u >= r &&
                        o >= u &&
                        !this.isAlreadySelected(l) &&
                        ((A = this.createComparisonValue(
                          f,
                          i,
                          u,
                          t,
                        ...
                        (void 0 === s || A > c) && ((s = l), (c = A)));
                  return s;
                }),
                (i.prototype.createComparisonValue = function(
                  t,
                  r,
                  o,
                  i,
                ...
                (i.prototype.weightedMean = function() {
                  var t, r, o, i, n, a;
                  for (
                    n = 1 <= arguments.length ? e.call(arguments, 0) : [],
                      r = 0,
                      o = 0,
                      t = 0;
                    t < n.length;
                ...
                (i.prototype.isAlreadySelected = function(t) {
                  return (
                    this.VibrantSwatch === t ||
                    this.DarkVibrantSwatch === t ||
                    this.LightVibrantSwatch === t ||
                    this.MutedSwatch === t ||
                    this.DarkMutedSwatch === t ||
                    this.LightMutedSwatch === t
                  );
                }),
