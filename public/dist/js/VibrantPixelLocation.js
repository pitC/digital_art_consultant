        ...
        (function() {
          ...
          window.Swatch = Swatch = (function() {
            ...
            Swatch.prototype.getHsl = function() {
              if (!this.hsl) {
                return (this.hsl = Vibrant.rgbToHsl(
                  this.rgb[0],
                  this.rgb[1],
                  this.rgb[2]
                ));
            ...
            Swatch.prototype._ensureTextColors = function() {
              if (!this.yiq) {
                return (this.yiq =
                  (this.rgb[0] * 299 + this.rgb[1] * 587 + this.rgb[2] * 114) /
                  1000);
              }
            };
          ...
          window.Vibrant = Vibrant = (function() {
            ...
            function Vibrant(sourceImage, colorCount, quality) {
              ...
              try {
                ...
                this._swatches = cmap.vboxes.map(
                  (function(_this) {
            ...
            Vibrant.prototype.generateEmptySwatches = function() {
              ...
              if (this.VibrantSwatch === void 0) {
                if (this.DarkVibrantSwatch !== void 0) {
                  ...
                  this.VibrantSwatch = new Swatch(
                    Vibrant.hslToRgb(hsl[0], hsl[1], hsl[2]),
                    0
                  );
                }
              }
              if (this.DarkVibrantSwatch === void 0) {
                if (this.VibrantSwatch !== void 0) {
                  ...
                  return (this.DarkVibrantSwatch = new Swatch(
                    Vibrant.hslToRgb(hsl[0], hsl[1], hsl[2]),
                    0
                  ));
                }
            ...
            Vibrant.prototype.findColorVariation = function(
              ...
              for (j = 0, len = ref.length; j < len; j++) {
                ...
                if (
                  ...
                  value = this.createComparisonValue(
                    sat,
                    targetSaturation,
                    luma,
                    targetLuma,
            ...
            Vibrant.prototype.createComparisonValue = function(
              saturation,
              targetSaturation,
              luma,
              targetLuma,
              ...
              return this.weightedMean(
                this.invertDiff(saturation, targetSaturation),
                this.WEIGHT_SATURATION,
                this.invertDiff(luma, targetLuma),
                this.WEIGHT_LUMA,
